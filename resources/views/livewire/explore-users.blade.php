<div>
    <div class="container mx-auto py-4">
        <div class="text-center lg:max-w-lg mx-auto">
            <input
                wire:model="search"
                type="text"
                placeholder="Search users..."
                autofocus
                class="rounded-lg border border-slate-400 w-full placeholder:text-slate-400 focus:border-slate-400 focus:ring-blue-500 transition ease-out duration-300">
        </div>
